...
.form-overlay { position: fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.4); display:none; }
.form-overlay.active { display:block; }

.form-slide { position: fixed; right:-400px; top:0; width:350px; height:100%; background:white; padding:25px; transition:0.3s; }
